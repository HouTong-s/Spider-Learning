...
class LongCommentsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        #这里的url是一个后端接口而不是网页
        url = "https://api.bilibili.com/pgc/review/long/list?media_id=4315402&ps=20&sort=0"
        yield Request(url)
    def parse(self, response):
        ...
        for one_comment in data["list"]:
            ...
            yield item
        next_url = "https://api.bilibili.com/pgc/review/long/list?media_id=4315402&ps=20&sort=0&cursor=%d"%next
